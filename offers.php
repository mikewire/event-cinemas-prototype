<? include("includes/header.php") ?>
  ...
  <div id="main" role="main" class="offers">
	  ...
	  <nav>
		...
		<ul>
			...
			<li class="active"><a href="offers.php">Promotions</a></li>					
	  ...
	  <div class="offers-wrapper">
		...
		<img src="img/offers.jpg" alt="cinema-overview" width="953" height="677" />
		<a class="to-detail" href="offers-detail.php"></a>
	  </div>
