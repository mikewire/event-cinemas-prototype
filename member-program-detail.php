<? include("includes/header.php") ?>
	...
	<div role="main" class="main movie-detail member-program-detail">	
		...
		<div class="movie-info">
			...
			<ul class="third-nav">
				<img src="img/logo-cinebuzz-rewards-large.png" alt="logo-cinebuzz-rewards-large" width="209" height="61" />
				<li><a id="overlay1">About Cinebuzz Rewards</a></li>
				<li><a id="overlay2">Earn and Redeem</a></li>
			</ul>
		...
		<div class="movie-detail-items">
	  	...
	  	<div class="call-to-action-member-programs">
			<p class="member-program-line">See your favourite movies, earn points, and redeem them for free movies and more!</p>			
			<a class="btn yellow" href="#">Join now</a>
		</div>
		<div class="clearfix"></div>
