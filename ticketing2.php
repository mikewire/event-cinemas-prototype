				...
				<div class="movie-overview-list">
					...
					<div class="movie-list-item">
						...
						<div class="cinema-movie-times-info">
		  					<strong class="title">Snow White and the Huntsman 7</strong> <p class="thin">120 mins</p>
		  					<div class="ratings">
						...
						<div class="quick-times-select-widget">
							...
							<span class="cinema-row">
								...
								<span class="not-showing">Not Showing</span>
							</span>  
						
						</div><!-- end quick-times-select-widget -->
						<div class="clearfix"></div>
					</div><!-- end movie list item -->
					...
					<div class="see-other-movies">
						<a class="btn blue">See other movies now showing</a>
					</div>
