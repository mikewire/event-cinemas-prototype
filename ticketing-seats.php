...
<body class="lights ticketing">
	...
	<header>
		<img class="logo" src="img/ec-logo.png" />
		...
		<div class="main">
			...
			<div class="left">
				...
				<ul class="top">
					...
					<li class="active">3. Seat Selection<span class="inner"></span><span class="outer"></span></li>
				...
				<div class="clearfix"></div>
				<span class="strip">
					<h2>Please select your preferred seats</h2>
				</span>
			...
			<div class="right">
				<span class="top">
					...
					<p class="time-remaining">Time remaining to complete booking: <span>10:00</span></p>
				...
				<div class="wrap" id="recap">
					...
					<strong>Number of tickets (<a href="#">Change</a>)</strong>	
					<p>1 x Adult</p>			
					<strong>Extras (<a href="#">Change</a>)</strong>	
					<p>1 x 3D Glasses</p>			
				</div>
